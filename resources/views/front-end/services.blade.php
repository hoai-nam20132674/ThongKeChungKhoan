...
@section('meta')
	...
	<meta property="og:image" content="{{asset('uploads/images/services/'.$categorie->avata)}}">
	<meta property="og:image:secure_url" content="{{asset('uploads/images/services/'.$categorie->avata)}}">
            ...
            <div class="row">
                <div class="col-xl-12 text-center">
                    <div class="page-title-content">
                        <h3 class="title text-white">{{$categorie->name}}</h3>
