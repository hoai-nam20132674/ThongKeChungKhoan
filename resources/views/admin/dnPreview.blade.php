...
<head>
    ...
    <title>Xem trước phiếu xuất kho</title>
...
<div class="no-print">
    ...
    <form id="postAddDn" action="{{URL::route('postAddDn')}}?str_ids={{$request->str_ids}}" method="POST">
                ...
                <div>
                        ...
                        <div class="col-xs-6 pull-left">
                            <h5 class="border-text">Khách hàng</h5>
                                ...
                                <tbody>
                                    <tr>
                                        <td>Họ tên</td>
                                        <td><input style="pointer-events: none;" class="form-control" placeholder="Họ tên khách hàng" value="{{$user_name}}" name="name" type="text" id="name"></td>
                                    </tr>
                                    <tr class="">
                                        <td>Email</td>
                                        <td><input class="form-control" placeholder="Email" value="" name="email" type="text" id="email"></td>
                                    </tr>
                                    
                                    <tr class="">
                                        <td>Điện thoại</td>
                                        <td><input style="pointer-events: none;" class="form-control" placeholder="Số điện thoại" value="{{$user_phone}}" name="phone" type="number" id="phone"></td>
                                    </tr>

                                    <tr class="">
                                        <td>Kho xuất</td>
                                        <td><input class="form-control" placeholder="Nhập kho xuất" value="" name="kx" type="text" id="kx"></td>
                                    </tr>
                                    <tr class="">
                                        <td>Nhân viên xuất</td>
                                        <td><input oninput="nvxk()" class="form-control" placeholder="Họ tên nhân viên xuất" value="" name="nvx" type="text" id="nvx"></td>
                                    </tr>
                                ...
                                <tbody>
                                    @php
                                        ...
                                        foreach($packages as $pa){
                                            $tiencan = $tiencan + $pa->price;
                                        }
                                    
                                    @endphp
                                    <tr>
                                        <td>1. Tiền cân</td>
                                        <td id="weight_money" class="text-right  bold"><input style="pointer-events: none;" class="form-control" placeholder="Tiền cân" value="{!!number_format($tiencan)!!} VNĐ" name="tiencan" type="text" id="tiencan"></td>
                                    </tr>
                                    
                                    <tr>
                                        <td>2. Phí phát sinh</td>
                                        <td id="china_ship" class="bold text-right"><input oninput="totalPrice()" class="form-control" placeholder="Phí phát sinh" value="" name="phiphatsinh" type="text" id="phiphatsinh"></td>
                                    </tr>
                                    
                                    <tr class="">
                                        <td>3. Phí Ship</td>
                                        <td class="text-right bold" title="Phí ship cho cả phiếu"><input class="form-control" placeholder="Phí ship" value="" name="phiship" oninput="totalPrice()" type="text" id="phiship"></td>
                                    </tr>
                                    ...
                                    <tr class="">
                                        <td>4. TỔNG TIỀN</td>
                                        <td class="text-right bold"><input style="pointer-events: none;" class="form-control" placeholder="Tổng tiền" value="" name="total" type="text" id="total"></td>
                                    </tr>
                                    <tr >
                                        <td>Ghi chú kho</td>
                                        <td  data-field='cu_vault_note'><input class="form-control" placeholder="Ghi chú" value="" name="message" type="text" id="message"></td>
                                    </tr>
                    ...
                    <div class='row mt-20 mb-20'>
                        <div class="col-xs-3">
                            ...
                            <input class="form-control" placeholder="" name="nt" type="datetime-local" id="nt">
                        </div>
                        <div class="col-xs-3">
                            <label for="ktn" class="control-label">Kế toán nhận</label>
                            <input class="form-control" placeholder="" name="ktn" type="datetime-local" id="ktn">
                        </div>
                        <div class="col-xs-3">
                            <label for="ns" class="control-label">Ngày ship</label>
                            <input class="form-control" placeholder="" name="ns" type="datetime-local" id="ns">
                        </div>
                        <div class="col-xs-3">
                            <label for="nth" class="control-label">Ngày trả hàng</label>
                            <input class="form-control" placeholder="" name="nth" type="datetime-local" id="nth">
                        </div>
                    </div>
                    <div>
                        <div>
