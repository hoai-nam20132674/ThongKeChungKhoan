...
@section('content')
	<div class="page-content ">
                    <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Thêm quy cách mới</li>
                    ...
                    <div id="main">
                        ...
                        @endif
                        <form method="POST" action="{{URL::route('postAddProperties')}}" enctype="multipart/form-data" accept-charset="UTF-8" id="form_1aa3f76ebce588e61c3b18ff42edfa1a">
                ...
                <div class="main-form">
                    <div class="form-body">
                        <div class="form-group"  >
                            ...
                            <label for="name" class="control-label required">T&ecirc;n quy cách</label>
