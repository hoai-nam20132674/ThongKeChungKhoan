...
@section('content')
	<div class="page-content ">
	    <ol class="breadcrumb">
	        ...
	        <li class="breadcrumb-item active">Thêm dự án mới</li>
	    </ol>
                    ...
                    <div id="main">
                        ...
                        @endif
                        <form method="POST" action="{{URL::route('postAddProject')}}" enctype="multipart/form-data" accept-charset="UTF-8" id="form_1aa3f76ebce588e61c3b18ff42edfa1a">
                ...
                <div class="main-form">
                    <div class="form-body">
                        ...
                        <div class="form-group"  >
                            ...
                            <textarea class="form-control" rows="4" placeholder="Nội dung" data-counter="400" name="content" cols="50" id="content" required>{{old('content')}}</textarea>
