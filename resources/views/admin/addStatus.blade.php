...
@section('content')
	<div class="page-content ">
                    <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Thêm trạng thái mới</li>
                    ...
                    <div id="main">
                        ...
                        @endif
                        <form method="POST" action="{{URL::route('postAddStatus')}}" enctype="multipart/form-data" accept-charset="UTF-8" id="form_1aa3f76ebce588e61c3b18ff42edfa1a">
                ...
                <div class="main-form">
                    <div class="form-body">
                        <div class="form-group"  >
                            ...
                            <input class="form-control" placeholder="Nhập tên trạng thái" data-counter="120" value="{{old('name')}}" name="name" type="text" required id="name">
                        </div>
