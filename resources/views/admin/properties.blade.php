...
@section('content')
	<div class="page-content ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Quy cách đóng gói</li>
		                            				...
		                            				<td class=" text-left no-sort">
			                            				<div class="text-left">
														    <div class="checkbox checkbox-primary table-checkbox">
														        <input type="checkbox" class="checkboxes" name="id[]" value="{{$pp->id}}">
														    </div>
														</div>
													</td>
													<td class="  column-key-id">{{$i++}}</td>
													<td class=" text-left column-key-name"><a href="#">{{$pp->name}}</a></td>
													<td class="  column-key-created_at">{{$pp->created_at}}</td>
													<td class="  column-key-updated_at">{{$pp->updated_at}}</td>
													
													<td class=" text-center">
														<a href="{{URL::route('editProperties',$pp->id)}}" class="btn btn-icon btn-primary" data-toggle="tooltip" data-original-title="Sửa"><i class="fa fa-edit"></i></a>
														<a href="#" class="btn btn-icon btn-danger deleteDialog delete" data-toggle="tooltip" data-section="{{URL::route('deleteProperties',$pp->id)}}" role="button" data-original-title="Xóa bản ghi"><i class="fa fa-trash"></i></a>
													</td>
												</tr>
										@endforeach
