...
<div class="page-content ">
	...
	<div id="main">
		@if( Session::has('flash_message'))
	    	...
	    	@endif
		<form method="POST" action="{{URL::route('postEditSE',$se->id)}}" enctype="multipart/form-data" accept-charset="UTF-8" id="form_1aa3f76ebce588e61c3b18ff42edfa1a">
			...
			<div class="row">
				<div class="col-md-9">
					...
					<div class="form-group"  >
                        ...
                        <input class="form-control" placeholder="Nhập tên sàn" data-counter="190" name="name" value="{{$se->name}}" type="text" id="name">
                    </div>
