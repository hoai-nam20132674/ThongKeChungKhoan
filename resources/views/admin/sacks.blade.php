...
@section('content')
	<div class="page-content ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Gói hàng</li>
		                ...
		                <div class="table-responsive  table-has-actions   table-has-filter ">
                            <div id="table-categories_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer" style="width: 100%;">
                            	...
                            	<div class="dt-buttons btn-group"> 
                            		<button class="btn btn-secondary action-item" tabindex="0" aria-controls="table-categories"><span><span data-action="create" data-href="{{URL::route('addSack')}}"><i class="fa fa-plus"></i> Tạo mới</span></span></button> 
                            	...
                            	<table class="table table-striped table-hover vertical-middle dataTable no-footer" id="table-categories" role="grid" aria-describedby="table-categories_info" style="width: 1582px;">
                            		<thead>
										<tr>
											...
											<th  title="Tên" class="text-left column-key-name">Mã gói hàng</th>
											...
											@endif
													<td class=" text-left no-sort">
														<div class="text-left">
														    <div class="checkbox checkbox-primary table-checkbox">
														        <input type="checkbox" class="checkboxes" name="id[]" value="{{$sack->id}}">
														    </div>
														</div>
													</td>
													<td class="column-key-id sorting_{{$i}}">{{$i}}</td>
													
													<td class=" text-left column-key-name"><a href="">{{$sack->ma}}</a></td>
													
													
													<td class="  column-key-created_at">{{$sack->created_at}}</td>
													
													<td class="  column-key-status"><a style="margin: 0px; padding: 2px; background-color: #36c6d3;color: #fff;" class="btn btn-sm btn-default">Chưa hoàn thành</a></td>
													...
													<td class=" text-center">
														<div class="table-actions">
										                    ...
										                    <a href="{{URL::route('editSack',$sack->id)}}" class="btn btn-icon btn-sm btn-primary" data-toggle="tooltip" data-original-title="Sửa">
										                    	<i class="fa fa-edit"></i>
										                    </a>
										        
										                    <a href="#" class="btn btn-icon btn-sm btn-danger deleteDialog delete" data-toggle="tooltip" data-section="{{URL::route('deleteSack',$sack->id)}}" role="button" data-original-title="Xóa bản ghi">
