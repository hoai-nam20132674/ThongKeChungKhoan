...
@section('content')
    @php
        $sack = App\Sack::where('id',$request->sack_id)->get()->first();
    @endphp
    <div class="page-content ">
        <ol class="breadcrumb">

            <li class="breadcrumb-item"><a href="{{URL::route('home')}}">Bảng điều khiển</a></li>
            <li class="breadcrumb-item"><a href="{{URL::route('editSack',$request->sack_id)}}">Bao hàng {{$sack->ma}}</a></li>
            <li class="breadcrumb-item active">Thêm kiện hàng mới</li>
        </ol>
                    ...
                    <div id="main">
                        ...
                        @endif
                        <form method="POST" action="{{URL::route('postAddPackage')}}" enctype="multipart/form-data" accept-charset="UTF-8" id="form_1aa3f76ebce588e61c3b18ff42edfa1a">
            ...
            <div class="row">
                    ...
                    <div class="main-form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Nhập mã kiện" value="{{old('ma')}}" name="ma" type="text" id="ma">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="main-form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Nhập mã vận đơn" value="{{old('mvd')}}" name="mvd" required type="text" id="mvd">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3" style="display: none;">
                    <div class="main-form">
                        <div class="form-body">
                            <div class="form-group">
                                <label for="sack_id" class="control-label required">Mã Bao</label>
                                <input class="form-control" placeholder="Nhập mã bao" value="{{$sack->id}}" name="sack_id" type="text" required id="sack_id">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="main-form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Nhập số lượng kiện" value="1" name="sl" required type="number" min="1" id="sl">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="main-form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Nhập họ tên" value="{{old('name')}}" name="name" type="text" required id="name">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="main-form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" data-counter="10" placeholder="Nhập số điện thoại" value="{{old('phone')}}" name="phone" type="number" required id="phone">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="main-form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Nhập kho khách chọn" value="{{old('kkc')}}" name="kkc" type="text" id="kkc">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="main-form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Nhập kho khách chọn" value="{{old('message')}}" name="message" type="text" id="message">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="main-form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Thời gian mua hàng xong" value="{{old('mhx')}}" name="mhx" type="datetime-local" id="mhx">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="main-form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Thời gian shop phát hàng" value="{{old('stqph')}}" name="stqph" type="datetime-local" id="stqph">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="main-form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Thời gian về kho TQ" value="{{old('ktqnh')}}" name="ktqnh" type="datetime-local" id="ktqnh">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="main-form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Thời gian xuất kho TQ" value="{{old('xktq')}}" name="xktq" type="datetime-local" id="xktq">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="main-form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Thời gian về kho VN" value="{{old('tkvn')}}" name="tkvn" type="datetime-local" id="tkvn">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="main-form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Thời gian trả hàng" value="{{old('dth')}}" name="dth" type="datetime-local" id="dth">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="main-form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Nhập kích thước dài" oninput="replaceValueInteger('dai');" value="{{old('dai')}}" name="dai" type="text" id="dai">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="main-form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Nhập kích thước rộng" oninput="replaceValueInteger('rong')" value="{{old('rong')}}" name="rong" type="text" id="rong">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="main-form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Nhập kích thước cao" oninput="replaceValueInteger('cao')" value="{{old('cao')}}" name="cao" type="text" id="cao">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="main-form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="" oninput="replaceValueInteger('cnqd')" value="{{old('cnqd')}}" name="cnqd" type="text" id="cnqd">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="main-form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Nhập cân nặng" oninput="replaceValueInteger('cannang')" value="{{old('cannang')}}" name="cannang" type="text" id="cannang">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="main-form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Nhập đơn giá cân" oninput="replaceValueInteger('dongiacan')" value="{{old('dongiacan')}}" name="dongiacan" type="text" id="dongiacan">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="main-form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Nhập đơn giá khối" oninput="replaceValueInteger('dongiakhoi')" value="{{old('dongiakhoi')}}" name="dongiakhoi" type="text" id="dongiakhoi">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="main-form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" value="" name="price" type="number" id="price">
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="form-actions form-actions-fixed-top hidden">
    <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{URL::route('home')}}">Bảng điều khiển</a></li>
            <li class="breadcrumb-item"><a href="{{URL::route('editSack',$request->sack_id)}}">Bao hàng</a></li>
            <li class="breadcrumb-item active">Thêm kiện hàng mới</li>
        </ol>
