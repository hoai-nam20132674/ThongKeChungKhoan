			...
			<div class="row">
				<div class="col-md-9">
					<div class="form-group"  >
                        ...
                        <input class="form-control" placeholder="Nhập tiêu đề" data-counter="190" name="title" value="{{old('title')}}" type="text" id="title">
                    </div>
                    <div class="form-group"  >
                        <label for="description" class="control-label">Mô tả</label>
                        <input class="form-control" placeholder="Nhập mô tả" name="description" value="{{old('description')}}" type="text" id="description">
                    </div>
