...
@section('content')
	<div class="page-content ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Trạng thái hàng hóa</li>
		                ...
		                <div class="table-responsive  table-has-actions   table-has-filter ">
                            <div id="table-categories_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer" style="width: 100%;">
                            	...
                            	<div class="dt-buttons btn-group"> 
                            		<button class="btn btn-secondary action-item" tabindex="0" aria-controls="table-categories"><span><span data-action="create" data-href="{{URL::route('addStatus')}}"><i class="fa fa-plus"></i> Tạo mới</span></span></button> 
		                            				...
		                            				<td class=" text-left no-sort">
			                            				<div class="text-left">
														    <div class="checkbox checkbox-primary table-checkbox">
														        <input type="checkbox" class="checkboxes" name="id[]" value="{{$stt->id}}">
														    </div>
														</div>
													</td>
													<td class="  column-key-id">{{$i++}}</td>
													<td class=" text-left column-key-name"><a href="#">{{$stt->name}}</a></td>
													<td class="  column-key-created_at">{{$stt->created_at}}</td>
													<td class="  column-key-updated_at">{{$stt->updated_at}}</td>
													
													<td class=" text-center">
														<a href="{{URL::route('editStatus',$stt->id)}}" class="btn btn-icon btn-primary" data-toggle="tooltip" data-original-title="Sửa"><i class="fa fa-edit"></i></a>
														<a href="#" class="btn btn-icon btn-danger deleteDialog delete" data-toggle="tooltip" data-section="{{URL::route('deleteStatus',$stt->id)}}" role="button" data-original-title="Xóa bản ghi"><i class="fa fa-trash"></i></a>
													</td>
												</tr>
										@endforeach
