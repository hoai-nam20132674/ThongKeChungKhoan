...
@section('content')
	<div class="page-content ">
                    <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{URL::route('projectCategories')}}">Danh mục dự án</a></li>
                    ...
                    <div id="main">
                        <form method="POST" action="{{URL::route('postEditProjectCategorie',$cate->id)}}" enctype="multipart/form-data" accept-charset="UTF-8" id="form_1aa3f76ebce588e61c3b18ff42edfa1a">
                            ...
                            <div class="image-box" style="border: 1px solid #e2e2e2;">
                                <div class="file-upload">   
                                    <div class="file-upload-content file-upload-content100" style="position: relative;">
                                        <img width="100%" class="file-upload-image file-upload-image100" src="{{asset('uploads/images/projects/categories/'.$cate->avata)}}" alt="your image" />
